...
//post Key object has a copy of the rightHandSideKey inside
//usage Key akey(bkey);
Key::Key(const Key& rightHandSideKey)
{
this->textingAbbreviation = rightHandSideKey.textingAbbreviation;
}
